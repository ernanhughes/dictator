...
public abstract class BucketListAdapter<T> extends ArrayAdapter<T> {
     ...
     *
     * @param minBucketElementWidthDip The minimum width in DIP of an element.
     */
    ...
    public View getView(int bucketPosition, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            L.i("Instantiating new bucket view");
        }
     ...
     * @param currentElement The current element for which the View should be constructed
