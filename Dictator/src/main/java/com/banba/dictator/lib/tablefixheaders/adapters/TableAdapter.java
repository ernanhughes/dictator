package com.banba.dictator.lib.tablefixheaders.adapters;
...
public interface TableAdapter {
    ...
    /**
     * How many rows are in the data game_list represented by this Adapter.
     *
    ...
    /**
     * How many columns are in the data game_list represented by this Adapter.
     *
     ...
     * data game_list. You can either create a View manually or inflate it from an
     * XML layout file.
     *
     * @param row    The row of the item within the adapter's data game_list of the
     *               item whose view we want. If the row is <code>-1</code> it is
     *               the header.
     * @param column The column of the item within the adapter's data game_list of the
