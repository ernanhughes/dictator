...
public class LightItalicTextView extends TextView {
    ...
    private void init(Context context) {
        ...
        try {
            Typeface tf = Typeface.createFromAsset(context.getAssets(), "roboto_lightitalic.ttf");
            setTypeface(tf);
        } catch (RuntimeException e) {
            throw new RuntimeException("Make sure you copied roboto_lightitalic.ttf to the 'assets'" + e.getMessage());
        }
    }
}
