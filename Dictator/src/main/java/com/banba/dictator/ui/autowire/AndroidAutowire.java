package com.banba.dictator.ui.autowire;
 ...
 * Activity Class
 * <pre class="prettyprint">
 * public class RecordToTextListActivity extends BaseActivity{
 * {@code @AndroidView}
...
public class AndroidAutowire {
     ...
     *                  but not {@link android.app.Activity}. <br /><br />All views annotated with {@code @AndroidView} will be autowired in all Activity classes in the
     *                  inheritance structure, from thisClass to baseClass inclusive. baseClass should not be {@link android.app.Activity} because no fields
     *                  in {@link android.app.Activity} will need to be autowired. <br /><br /> If there is no parent class for your activity, use thisClass.class as baseClass.
     ...
     *
     * @param bundle    {@link android.os.Bundle} to save the Activity/Fragment's state
     ...
     *
     * @param bundle    {@link android.os.Bundle} with the Activity/Fragment's saved state.
