package com.banba.dictator.ui.view;
...
public class AutoFitText extends TextView {
    ...
    /**
     * A dummy {@link android.widget.TextView} to test the text size without actually showing anything to the user
     */
    private TextView mTestView;

    /**
     * A dummy {@link android.graphics.Paint} to test the text size without actually showing anything to the user
     */
     ...
     */
        int MIN_TEXT_SIZE = 10;
        float lowerTextSize = MIN_TEXT_SIZE;
        int MAX_TEXT_SIZE = 400;
    ...
    /**
     * This method is guaranteed to be called by {@link android.widget.TextView#setText(CharSequence)} immediately.
     * Therefore we can safely add our modifications here and then have the parent class resume its
     * work. So if text has changed you should always call {@link android.widget.TextView#setText(CharSequence)} or
     * {@link android.widget.TextView#setText(CharSequence, android.widget.TextView.BufferType)} if you know whether the {@link android.widget.TextView.BufferType}
     * is normal, editable or spannable. Note: the method will default to {@link android.widget.TextView.BufferType#NORMAL}
